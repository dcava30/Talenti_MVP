...
def _build_interview_response(
    ...
    return InterviewResponse(
        ...
        call_connection_id=interview.call_connection_id,
        server_call_id=interview.server_call_id,
        recording_id=interview.recording_id,
        recording_started=interview.recording_started,
        recording_processed=interview.recording_processed,
        recording_status=interview.recording_status,
        recording_error=interview.recording_error,
        recording_started_at=interview.recording_started_at,
        recording_stopped_at=interview.recording_stopped_at,
