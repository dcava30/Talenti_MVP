...
export const useInterviewPersistence = () => {
     ...
     */
    const saveTranscriptSegment = useCallback(async (interviewIdParam, segment) => {
        try {
     ...
     */
    const updateAntiCheatSignals = useCallback(async (interviewIdParam, signals) => {
        try {
     ...
     */
    const getOrCreateDemoApplication = useCallback(async () => {
        try {
