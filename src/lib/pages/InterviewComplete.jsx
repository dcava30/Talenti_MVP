    ...
    return (<div className="min-h-screen bg-background flex items-center justify-center p-4">
      <Card className="max-w-2xl w-full p-8">
        <div className="text-center space-y-6">
          ...
          {/* Scoring Status */}
          {interviewId && scoringStatus === "scoring" && (<Card className="bg-accent/30 p-6">
          ...
          {scoreResult && scoringStatus === "complete" && (<Card className="bg-gradient-to-br from-primary/5 to-primary/10 p-6 space-y-4">
              <div className="flex items-center justify-center gap-3">
              ...
              {scoreResult.score_dimensions && scoreResult.score_dimensions.length > 0 && (<div className="space-y-2 pt-4 border-t border-border/50">
                  <p className="text-sm font-medium mb-3">Performance Breakdown</p>
                  <div className="grid grid-cols-2 gap-2 text-left">
                    {scoreResult.score_dimensions.slice(0, 4).map((dim) => (<div key={dim.dimension} className="space-y-1">
              ...
              {/* Candidate Feedback */}
              {scoreResult.candidate_feedback && (<div className="pt-4 border-t border-border/50 text-left">
          ...
          {scoringStatus === "error" && (<Card className="bg-destructive/5 p-4">
