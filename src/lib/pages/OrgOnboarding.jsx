                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input id="orgName" placeholder="Acme Corporation" value={orgName} onChange={(e) => setOrgName(e.target.value)} className="pl-10" required/>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input id="website" type="url" placeholder="https://www.example.com" value={website} onChange={(e) => setWebsite(e.target.value)} className="pl-10"/>
                    </div>
                  </div>
                </div>

                <Button type="button" className="w-full" onClick={() => setStep(2)} disabled={!orgName.trim()}>
                  Continue
            ...
            {step === 2 && (<div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Textarea id="description" placeholder="Tell candidates about your company, culture, and mission..." value={description} onChange={(e) => setDescription(e.target.value)} rows={4}/>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input id="billingEmail" type="email" placeholder="billing@example.com" value={billingEmail} onChange={(e) => setBillingEmail(e.target.value)} className="pl-10"/>
                    </div>
