...
export const OrgDataRetentionSettings = ({ organisationId, currentRetentionDays, }) => {
      ...
      <div className="space-y-8 max-w-lg">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-4 pt-2">
            ...
            <Slider value={[retentionDays]} onValueChange={(value) => setRetentionDays(value[0])} min={30} max={60} step={1} className="w-full"/>
          </div>
        </div>
