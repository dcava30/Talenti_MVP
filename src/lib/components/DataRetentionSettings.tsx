...
export const DataRetentionSettings = () => {
  const [requestType, setRequestType] = useState<"full_deletion" | "recording_only" | "anonymize">("full_deletion");
  ...
  return (
    <div className="space-y-6">
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <RadioGroup value={requestType} onValueChange={(v) => setRequestType(v as any)} className="space-y-3">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                id="reason"
                placeholder="Please let us know why you're requesting deletion..."
                value={reason}
            ...
            <AlertDialog open={showConfirmDialog} onOpenChange={setShowConfirmDialog}>
              <AlertDialogTrigger asChild>
                <Button 
                  variant={requestType === "full_deletion" ? "destructive" : "default"}
              ...
              <AlertDialogContent>
                ...
                <AlertDialogFooter>
                  ...
                  <AlertDialogAction
                    ...
                    className={requestType === "full_deletion" ? "bg-destructive hover:bg-destructive/90" : ""}
                  >
                    Confirm Request
                  </AlertDialogAction>
                </AlertDialogFooter>
      ...
      {/* Previous Requests */}
      {!isLoading && deletionRequests && deletionRequests.length > 0 && (
        <Card>
          <CardHeader>
