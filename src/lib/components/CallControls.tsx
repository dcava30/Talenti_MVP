        ...
        <TooltipTrigger asChild>
          <Button
            ...
            className={cn(
              ...
              !isMuted && 'bg-secondary hover:bg-secondary/80'
            )}
        ...
        <TooltipTrigger asChild>
          <Button
            ...
            className={cn(
              ...
              isVideoOn && 'bg-secondary hover:bg-secondary/80'
            )}
...
interface CallControlsInlineProps {
  isMuted: boolean;
  isVideoOn: boolean;
  onToggleMute: () => void;
  onToggleVideo: () => void;
...
export const CallControlsInline: React.FC<CallControlsInlineProps> = ({
  isMuted,
  isVideoOn,
  onToggleMute,
  onToggleVideo,
